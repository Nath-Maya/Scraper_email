...
class Settings:
    ...
    def safe_print(self) -> None:
        print("⚙️  Config cargada:")
        print(f"   • RACKSPACE_URL: {self.RACKSPACE_URL}")
        print(f"   • RACKSPACE_USERNAME: {_mask_secret(self.RACKSPACE_USERNAME, 3, 3)}")
        print(f"   • RACKSPACE_PASSWORD: {_mask_secret(self.RACKSPACE_PASSWORD, 0, 0)}")
